  ...
  return (
    <>
      ...
      <div id="about-main">
        <div id="about-outer">
          <div id="about-inner">
            <div role="article" className="about-tab">
              <div className="content">
                <aside className="about-aside">
                  <h2>Big teeth means big personality!</h2>
                  <p>
                    I grew up Sheffield with my parents and 2-year-younger
                    brother. I think it goes without saying that, being the
                    older brother, I felt the incessant need to wind up my
                    brother and constantly get sent to the naughty step. I find
                    this quite funny since, when we were anywhere but at home, I
                    was the best behaved kid you've ever seen. I guess I just
                    didn't want strangers to see me cry when I was getting
                    yelled at!
                  </p>
              ...
              <div className="content">
                ...
                <aside className="about-aside">
                  ...
                  <p>
                    ...
                    solve and the way you solve each one can be completely
                    unique to you. Coincidentally, this perfectly summarises my
                    love for climbing. I began when I was 8 years old and it
                    developed from ...
                  </p>
                  <p className="it-text">
              ...
              <div className="content">
                <aside className="about-aside">
                  ...
                  <p>
                    ...
                    did maths at uni... stick with what you're good at I
                    suppose. <br />I know it sounds like I'm regretful but that
                    couldn't be farther from reality! I loved maths at
                    university! It just took a while to adjust to the fact that
                    my average grade naturally dropped from 90% to 65%
                    &#128557;.
                  </p>
                  <p>
                  ...
                  <p>
                    and I'm happy to say that my time at Warwick was no
                    exception.
                  </p>
                </aside>
                <img
            ...
            <div role="article" className="about-tab">
              ...
              <div className="content">
                ...
                <aside className="about-aside">
                  ...
                  <p>
                    If I'm being completely honest, the only reason I want to
                    earn any money in life is so that I can explore all the
                    incredible places in the world. I reckon I could survive on
                    a single cracker for every meal if it meant I could afford
                    to do this!
                  </p>
                  <p>
                  ...
                  <p>
                    I'm not sure where I should go next... what do you think?
                  </p>
                  <form>
